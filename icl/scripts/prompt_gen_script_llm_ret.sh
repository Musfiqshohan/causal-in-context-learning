...
BASE_CMD="python prompt_generation.py --gpu_id $GPU_ID --exp_name llm_ret --domain_name ood --emb_model gpt --prompt_style 0 --use_system_prompt --use_instruction --x_title Text --ckp $CKP --selection_method $RM --overwrite"
